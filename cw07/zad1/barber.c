...
int main(int argc, const char *argv[])
{
    ...
    int semBarbers = semaphoreOpen(SEM_BARBERS);
    int semShmMem = semaphoreOpen(SHARED_MEM);
    int semChairs = semaphoreOpen(SEM_CHAIRS);
    int semQueue = semaphoreOpen(SEM_QUEUE);
